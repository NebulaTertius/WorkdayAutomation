...
namespace AI.Automation
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(AIEmployeeSource),
            typeof(AIAllowanceAndOTPSource),
            typeof(AIAbsenceSource),
            typeof(AICatalogMapping),
            typeof(AIEmployeeQueue),
            typeof(AIFinancialQueue),
            typeof(AILeaveBalanceQueue),
            typeof(AIQueueMapping),
            typeof(AIEmployeeSubQueue),
            typeof(AILeaveTransactionQueue),
            typeof(AIEventTracker)
        };
        ...
        public static string ConnectionString = WorkdayAutomationAegis.MainView.ConnectionString;
